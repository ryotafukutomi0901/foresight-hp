  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      */}
      ...
      {/*
        左からのスクリム。コピーが乗る面を作る。
        映像を右へ寄せた分、以前より弱くてよい。強く掛けると
        車の前面まで暗くなり、ヘッドライトの見せ場が死ぬ。
      */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(90deg, rgba(9,9,9,1) 0%, rgba(9,9,9,0.96) 20%, rgba(9,9,9,0.6) 34%, rgba(9,9,9,0.1) 50%, rgba(9,9,9,0) 62%)",
        }}
      />
