...
export const edges = {
   ...
   * 法線差の閾値。
   *
   * 0.35(申し送り書の初期提案)で実測したところ、写実テクスチャの
   * 微小な凹凸まで線として拾い、ボディ面が斑点だらけになった。
   * 0.8 まで上げると、シルエット・ルーフレール・窓枠・
   * フェンダーアーチという「設計線」だけが残り、
   * 参照PNGの1px線画のトーンに最も近づく。
   */
  normalThreshold: 0.8,
  /** 深度差の閾値。シルエットの出方を決める */
...
export const vehicle = {
  ...
  camera: {
     ...
     * 車は静かな背景として下に置く。
     */
    contact: { x: 0, y: 2.3, z: 15.5, lookY: 1.75 },
  },
