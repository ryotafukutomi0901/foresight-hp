...
export const SERVICES = {
  ...
  items: [
    ...
    },
    {
      ...
      index: "03",
      label: "FIND",
      audience: "条件が決まっている方へ",
      headline: ["全国から、あなたの", "一台を探し出す。"],
      body: "在庫にない車でも諦めないでください。年式・色・走行距離・予算の条件をもとに、全国各地のオークション・業者ネットワークから探します。実車を直接確認してからご提案するので、写真だけの判断はしません。",
      points: [
        "全国オークション・業者網から探索",
        "実車確認後にのみ提案",
        "見つからない場合は正直にご報告",
